...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="${resourceServer }/img/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="${basepath }/brand/list.do" target="right"><span class="icon-caret-right"></span>品牌管理</a></li>
    <li><a href="${basepath }/product/list.do" target="right"><span class="icon-caret-right"></span>商品管理</a></li>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="${basepath }/info.do" name="right" width="100%" height="100%"></iframe>
</div>
