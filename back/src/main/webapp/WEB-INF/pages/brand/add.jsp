			...
			<div class="body-content">
				<form method="post" class="form-x" enctype="multipart/form-data" >
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="name" data-validate="required:请输入品牌名" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" id="url" name="img" class="input tips" style="width:25%; float:left;" value=""  data-toggle="hover" data-place="right" data-image="" />
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="webSite"  />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="sort"  data-validate="plusinteger:排序必须为数字" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
