		...
		<form method="post" class="form-x" enctype="multipart/form-data">
			<div class="body-content" v-show="selected==1">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="sort"
							data-validate="plusinteger:排序必须为数字" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<label><input name="isNew" type="radio" value="1">是</label>&nbsp;&nbsp;
				...
				<div class="form-group">
					...
					<div class="field">
						<label><input name="isCommend" type="radio" value="1">是</label>&nbsp;&nbsp;
						<label><input name="isCommend" type="radio" value="0">否</label>&nbsp;&nbsp;
					</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="price"
							data-validate="required:请输入参考价,plusdouble:必须是小数	" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="sales"
							data-validate="required:请输入参考价,plusinteger:必须是正整数	" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
							...
							<c:forEach items="${storages }" var="storage">
								<label><input name="storageList" type="checkbox"
									value="${storage.id }">${storage.name }</label>&nbsp;&nbsp;						
							</c:forEach>
