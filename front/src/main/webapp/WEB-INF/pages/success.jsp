...
<link href="${resourceServer }/css/cartstyle.css" rel="stylesheet"
	type="text/css" />
<link href="${resourceServer }/css/sustyle.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<div class="take-delivery">
		<div class="status">
			...
			<div class="successInfo">
				<ul>
					<li>付款金额<em>¥<%=session.getAttribute("money") %> </em></li>
					<div class="user-info">
						<p>收货人：{{userinfo.usr}}</p>
						<p>联系电话：{{userinfo.tel}}</p>
						<p>收货地址：{{userinfo.sheng}} {{userinfo.shi}} {{userinfo.xian}} {{userinfo.description}}</p>
					</div>
				...
				<div class="option">
					<span class="info">您可以</span> <a
						href="${resourceServer }/person/order.html" class="J_MakePoint">查看<span>已买到的宝贝</span></a>
					<a href="${resourceServer }/person/orderinfo.html"
	...
	<script type="text/javascript">
		...
		var info;
		$.ajax({
			url:"${basepath}/product/getInfo.do?id=<%=session.getAttribute("id")%>",
			async:false,
			type:"get",
			dataType:"json",
